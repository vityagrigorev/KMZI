...
class AES:
    ...
    def change_key(self, master_key):
        self.key_round = text2matrix(master_key)
...
if __name__ == '__main__':
    ...
    master_key = read(in_arg.keyF)
    
    master_key = master_key[0:len(master_key)-1]
    ...
    #print 'inText:', (data)
    #print 'inKey:', (master_key)
    
    if in_arg.mod == 'c':
        encoded = my_AES.encode(data)
        final_value = encoded
        #print 'encoded:', (encoded)
    if in_arg.mod == 'd':
        decoded = my_AES.decode(data)
        final_value = decoded
